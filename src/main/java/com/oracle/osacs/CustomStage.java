...
@OsaStage(name = "md5", description = "Create an md5 hex from a string", inputSpec = "input, job_id:string, job_title:string, min_salary:string, max_salary:string", outputSpec = "output, job_id:string, job_title:string, min_salary:string, max_salary:string")
public class CustomStage implements EventProcessor {
	...
	public Event processEvent(Event event) {
		...
		values.put("min_salary", min_salary);
		values.put("max_salary", max_salary);
